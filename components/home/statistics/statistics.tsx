...
import { FeaturedPosts, LiveStats, StatsTitle, StatsWrapper, LiveStatsContainer, CTALink } from "./statistics.style";
      ...
      <LiveStats>
        ...
        <LiveStatsContainer>
          ...
          <CTALastProject href="https://tasks.quicktools.co/" target="_blank">
            <StatsCard title="Latest project" description="Quicktools | Task Tracker" />
          </CTALastProject>
          <StatsCard
